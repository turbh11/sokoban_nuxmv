...
base_folder = r'C:\Users\user\OneDrive - Bar-Ilan University - Students\תואר שני\סמסטר א\אימות פורמלי וסינטזה\תרגילים\תרגילים של השנה\project\part_3'
...
class Sokoban:
  ...
  # Down
    ...
    def run_smv(self, smv_file, engine='SAT'):
        ...
        output_filename = os.path.join(output_folder, f"Solution_{name_without_ext}_{engine}.out")  # Append the engine to the filename
        run_com += base_name
